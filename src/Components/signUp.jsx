            ...
            <div className="max-w-150 w-full bg-white p-8 rounded-lg shadow-md">
              ...
              <div className="flex flex-col md:flex-row gap-6 mb-6">
                <div className="w-full">
                  <label htmlFor="first" className="block mb-1 text-sm font-medium">
                    Current Job Title
                  </label>
              ...
              <div className="flex justify-between items-center">
                ...
                <button type="submit" onSubmit={handleSubmit} className="bg-gradient-to-r from-purple-800 via-purple-600 to-purple-500 text-white py-2 px-10 rounded-md hover:opacity-90 w-105 transition">
                  Create Account
                </button>
              </div>
